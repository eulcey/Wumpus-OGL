...
public:
  ...
  bool setWindowSizeAction(std::function<void (int, int)> action);
...
private:
  ...
  static void windowSizeCallbackImpl(GLFWwindow *window, int, int);
  ...
  std::function<void (int, int)> windowSizeChange;
};
